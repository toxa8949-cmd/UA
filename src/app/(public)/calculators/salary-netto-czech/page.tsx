      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "Податок зменшується на sleva na poplatníka (2 570 Kč/міс) та пільги на дітей (sleva na dítě). Якщо дитяча пільга перевищує податок, різниця повертається як daňový bonus — доплата до зарплати.",
          ]}
          faqs={[
            {
        ...
        <RelatedCalculators currentSlug="salary-netto-czech" />
      </div>
    </>
  );
}
