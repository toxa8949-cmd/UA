      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "Податок з доходу — 15% (23% для високих доходів понад 1 762 812 Kč/рік), зменшується на sleva na poplatníka 30 840 Kč/рік. Соціальне (sociální) та медичне (zdravotní) страхування рахуються від частки прибутку. Розрахунок за актуальними ставками 2026 року. Для точного вибору режиму радимо консультацію бухгалтера.",
          ]}
          faqs={[
            {
