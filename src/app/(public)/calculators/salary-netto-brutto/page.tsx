      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "З brutto утримуються соціальні внески працівника ZUS (13,71%), медичний внесок składka zdrowotna (9%) та податок PIT (12% до 120 000 zł/рік, 32% вище) з урахуванням неоподатковуваної суми kwota wolna. Розрахунок за актуальними ставками 2026 року.",
          ]}
          faqs={[
            {
