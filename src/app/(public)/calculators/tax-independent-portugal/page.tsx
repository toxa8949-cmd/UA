      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "Segurança Social рахується окремо — від 70% доходу за ставкою 21,4% (фактично близько 15% від обороту). Для новачків діє пільга: коефіцієнт −50% у перший рік і звільнення від соцвнесків перші 12 місяців.",
          ]}
          faqs={[
            {
