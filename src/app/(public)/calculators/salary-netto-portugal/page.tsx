      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "IRS утримується не за річними траншами, а за офіційними таблицями retenção na fonte (Tabela I для não casado sem dependentes), затвердженими на 2026 рік. Розмір залежить від зарплати й сімейного стану. Розрахунок за актуальними таблицями 2026 року для континентальної Португалії.",
          ]}
          faqs={[
            {
