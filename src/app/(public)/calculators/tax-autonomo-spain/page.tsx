      ...
      <div className="container pb-16">
        ...
        <CalculatorSeoBlock
          ...
          intro={[
            ...
            "IRPF — прогресивний податок за траншами від 19% до 47%, з урахуванням mínimo personal 5 550 €. У режимі estimación directa simplificada можна списати 5% витрат без чеків (gastos de difícil justificación, максимум 2 000 €).",
          ]}
          faqs={[
            {
