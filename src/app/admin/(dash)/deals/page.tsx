  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/deals/new" className="inline-flex items-center gap-2 rounded-lg bg-emerald px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">
